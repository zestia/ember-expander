...
const w=(0,r.createTemplateFactory)({id:"WwTWfG+g",block:'[[[1,[28,[30,0,["registerComponents"]],[[30,0]],[["Content"],[[50,[28,[37,1],[[30,0,["ExpanderContent"]]],null],0,null,[["onInsert","style"],[[30,0,["registerContentElement"]],[30,0,["style"]]]]]]]]],[1,"\\n"],[11,0],[16,0,[28,[37,2],["expander",[52,[30,0,["isTransitioning"]]," expander--transitioning"]],null]],[16,"aria-expanded",[29,[[30,0,["isExpanded"]]]]],[24,"tabindex","0"],[17,1],[4,[30,0,["lifecycleHooks"]],[[30,2]],[["didInstall","didUpdateArguments"],[[30,0,["handleInsertElement"]],[30,0,["handleUpdatedArguments"]]]]],[12],[1,"\\n  "],[18,3,[[30,0,["api"]]]],[1,"\\n"],[13]],["&attrs","@expanded","&default"],false,["component","ensure-safe-component","concat","if","yield"]]',moduleName:"@zestia/ember-expander/components/expander/index.hbs",isStrictMode:!1}),{assign:O}=Object
class T extends a.default{didInstall(){this.args.named.didInstall(this.element)}didUpdateArguments(){this.args.named.didUpdateArguments?.()}willDestroy(){super.willDestroy(...arguments),this.args.named.willDestroy?.()}}e.LifecycleHooks=T
const k=(0,l.helper)((function(e,t){let[r]=e
O(r,t)}))
let R=(f=class extends n.default{constructor(){super(...arguments),_(this,"ExpanderContent",i.default),_(this,"lifecycleHooks",T),_(this,"registerComponents",k),y(this,"maxHeight",m,this),y(this,"isExpanded",v,this),y(this,"renderContent",g,this),y(this,"isTransitioning",b,this)}get api(){return{Content:this.renderContent?this.Content:null,toggle:this.toggle,expand:this.expand,collapse:this.collapse,isExpanded:this.isExpanded,isTransitioning:this.isTransitioning}}get style(){let e=""
return null!==this.maxHeight&&(e=`max-height: ${this.maxHeight}px`),(0,s.htmlSafe)(e)}handleInsertElement(){this.args.onReady?.(this.api)}handleUpdatedArguments(){(0,c.next)((()=>this._handleManualState()))}registerContentElement(e){this.contentElement=e}async expand(){if(!this.isExpanded){this.isTransitioning&&this.collapseTask.cancel(),this.expandTask=this._expand.perform()
...
try{await this.collapseTask,this.args.onCollapsed?.()}catch{}}}toggle(){this.isExpanded?this.collapse():this.expand()}*_expand(){this.renderContent=!0,this.isExpanded=!0,this.maxHeight=0,yield this._waitForRender(),this.maxHeight=this.contentElement.scrollHeight,this.isTransitioning=!0,yield this._waitForTransition(),this.isTransitioning=!1,this.maxHeight=null}*_collapse(){this.isExpanded=!1,this.maxHeight=this.contentElement.scrollHeight,yield this._waitForRender(),this.contentElement.getBoundingClientRect(),this.maxHeight=0,this.isTransitioning=!0,yield this._waitForTransition(),this.isTransitioning=!1,this.renderContent=!1,this.maxHeight=null}_handleManualState(){!0===this.args.expanded?this.expand():!1===this.args.expanded&&this.collapse()}_waitForRender(){return new Promise((e=>{(0,c.scheduleOnce)("afterRender",e)}))}_waitForTransition(){return(0,p.waitForAnimation)(this.contentElement,{transitionProperty:"max-height"})}},m=E(f.prototype,"maxHeight",[o.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return null}}),v=E(f.prototype,"isExpanded",[o.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return!!this.args.expanded}}),g=E(f.prototype,"renderContent",[o.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return!!this.args.expanded}}),b=E(f.prototype,"isTransitioning",[o.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return!1}}),E(f.prototype,"handleInsertElement",[d.action],Object.getOwnPropertyDescriptor(f.prototype,"handleInsertElement"),f.prototype),E(f.prototype,"handleUpdatedArguments",[d.action],Object.getOwnPropertyDescriptor(f.prototype,"handleUpdatedArguments"),f.prototype),E(f.prototype,"registerContentElement",[d.action],Object.getOwnPropertyDescriptor(f.prototype,"registerContentElement"),f.prototype),E(f.prototype,"expand",[d.action],Object.getOwnPropertyDescriptor(f.prototype,"expand"),f.prototype),E(f.prototype,"collapse",[d.action],Object.getOwnPropertyDescriptor(f.prototype,"collapse"),f.prototype),E(f.prototype,"toggle",[d.action],Object.getOwnPropertyDescriptor(f.prototype,"toggle"),f.prototype),E(f.prototype,"_expand",[h.task,u.waitFor],Object.getOwnPropertyDescriptor(f.prototype,"_expand"),f.prototype),E(f.prototype,"_collapse",[h.task,u.waitFor],Object.getOwnPropertyDescriptor(f.prototype,"_collapse"),f.prototype),f)
