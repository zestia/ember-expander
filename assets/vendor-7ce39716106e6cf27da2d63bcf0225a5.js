...
Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
const t=Ember.HTMLBars.template({id:"SxIMR32g",block:'[[[1,"\\n"],[1,"\\n"],[11,0],[24,0,"expander__content"],[16,5,[30,1]],[17,2],[4,[38,0],[[30,3]],null],[4,[38,1],["transitionend",[30,4]],null],[12],[1,"\\n  "],[18,5,null],[1,"\\n"],[13]],["@style","&attrs","@onInsert","@onTransitionEnd","&default"],false,["did-insert","on","yield"]]',moduleName:"@zestia/ember-expander/components/expander/content.hbs",isStrictMode:!1})
var r=Ember._setComponentTemplate(t,Ember._templateOnlyComponent())
e.default=r})),define("@zestia/ember-expander/components/expander/index",["exports","@glimmer/component","@zestia/ember-expander/components/expander/content","@ember/test-waiters"],(function(e,t,r,n){"use strict"
var i,a,s,o,l,u,c,d,h,p,f,m,v,g,b,y,_,E,w
function O(e,t,r,n){r&&Object.defineProperty(e,t,{enumerable:r.enumerable,configurable:r.configurable,writable:r.writable,value:r.initializer?r.initializer.call(n):void 0})}function T(e,t,r){return t in e?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r,e}function R(e,t,r,n,i){var a={}
...
const C=Ember.HTMLBars.template({id:"4VmgTzp2",block:'[[[44,[[28,[37,1],null,[["Content","toggle","toggleWithTransition","expand","expandWithTransition","collapse","collapseWithTransition","isExpanded","isTransitioning"],[[52,[30,0,["renderContent"]],[50,[28,[37,4],[[30,0,["ExpanderContent"]]],null],0,null,[["onInsert","onTransitionEnd","style"],[[30,0,["registerContentElement"]],[30,0,["handleTransitionEnd"]],[30,0,["style"]]]]]],[30,0,["toggle"]],[30,0,["toggleWithTransition"]],[30,0,["expand"]],[30,0,["expandWithTransition"]],[30,0,["collapse"]],[30,0,["collapseWithTransition"]],[30,0,["isExpanded"]],[30,0,["isTransitioning"]]]]]],[[[1,"  "],[11,0],[16,0,[28,[37,5],["expander",[52,[30,0,["isTransitioning"]]," expander--transitioning"]],null]],[16,"aria-expanded",[29,[[30,0,["isExpanded"]]]]],[17,2],[4,[38,6],[[28,[37,7],[[30,0,["handleInsertElement"]],[30,1]],null]],null],[4,[38,8],[[30,0,["handleUpdateExpanded"]],[30,3]],null],[12],[1,"\\n    "],[18,4,[[30,1]]],[1,"\\n  "],[13],[1,"\\n"]],[1]]]],["api","&attrs","@expanded","&default"],false,["let","hash","if","component","ensure-safe-component","concat","did-insert","fn","did-update","yield"]]',moduleName:"@zestia/ember-expander/components/expander/index.hbs",isStrictMode:!1}),{requestAnimationFrame:P}=window
let S=(i=Ember._tracked,a=Ember._tracked,s=Ember._tracked,o=Ember._tracked,l=Ember._action,u=Ember._action,c=Ember._action,d=Ember._action,h=Ember._action,p=Ember._action,f=Ember._action,m=Ember._action,v=Ember._action,g=Ember._action,b=class extends t.default{constructor(...e){super(...e),T(this,"ExpanderContent",r.default),T(this,"willTransition",null),O(this,"maxHeight",y,this),O(this,"isExpanded",_,this),O(this,"isTransitioning",E,this),O(this,"renderContent",w,this)}get style(){let e=""
return null!==this.maxHeight&&(e=`max-height: ${this.maxHeight}px`),Ember.String.htmlSafe(e)}handleInsertElement(){this._handleReady(...arguments),this._handleManualState()}handleUpdateExpanded(){this._handleManualState()}handleTransitionEnd(e){e.target===this.contentElement&&"max-height"===e.propertyName&&(this.willTransition.resolve(),this.willTransition=null)}expand(){this._expand()}expandWithTransition(){return this._expandWithTransition()}collapse(){this._collapse()}collapseWithTransition(){return this._collapseWithTransition()}toggle(){this._toggle()}toggleWithTransition(e){return this._toggleWithTransition()}registerContentElement(e){this.contentElement=e}_handleReady(e){var t,r
...
this.renderContent=!1,null===(e=(t=this.args).onAfterCollapse)||void 0===e||e.call(t)}_collapseWithTransition(){return this.isExpanded=!1,this.isTransitioning=!0,(0,n.waitForPromise)(this._waitForFrame().then((()=>this._adjustToScrollHeight())).then((()=>this._waitForFrame())).then((()=>this._adjustToZeroHeight())).then((()=>this._waitForTransition())).then((()=>this._adjustToNoneHeight())).then((()=>this._afterCollapseWithTransition())))}_afterCollapseWithTransition(){var e,t
...
null===(e=(t=this.args).onAfterExpand)||void 0===e||e.call(t)}_expandWithTransition(){return this.renderContent=!0,this.isExpanded=!0,this.isTransitioning=!0,(0,n.waitForPromise)(this._waitForFrame().then((()=>this._adjustToZeroHeight())).then((()=>this._waitForFrame())).then((()=>this._adjustToScrollHeight())).then((()=>this._waitForTransition())).then((()=>this._adjustToNoneHeight())).then((()=>this._afterExpandWithTransition())))}_afterExpandWithTransition(){var e,t
this.isTransitioning=!1,null===(e=(t=this.args).onAfterExpandTransition)||void 0===e||e.call(t)}_toggle(){this.renderContent?this._collapse():this._expand()}_toggleWithTransition(){return this.renderContent?this._collapseWithTransition():this._expandWithTransition()}_adjustToZeroHeight(){this.maxHeight=0}_adjustToNoneHeight(){this.maxHeight=null}_adjustToScrollHeight(){this.maxHeight=this.contentElement.scrollHeight}_waitForRender(){return new Ember.RSVP.Promise((e=>Ember.run.scheduleOnce("afterRender",this,e)))}_waitForFrame(){return new Ember.RSVP.Promise(P)}_waitForTransition(){return this.willTransition=Ember.RSVP.defer(),this.willTransition.promise}},y=R(b.prototype,"maxHeight",[i],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return null}}),_=R(b.prototype,"isExpanded",[a],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return!1}}),E=R(b.prototype,"isTransitioning",[s],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return!1}}),w=R(b.prototype,"renderContent",[o],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return!1}}),R(b.prototype,"handleInsertElement",[l],Object.getOwnPropertyDescriptor(b.prototype,"handleInsertElement"),b.prototype),R(b.prototype,"handleUpdateExpanded",[u],Object.getOwnPropertyDescriptor(b.prototype,"handleUpdateExpanded"),b.prototype),R(b.prototype,"handleTransitionEnd",[c],Object.getOwnPropertyDescriptor(b.prototype,"handleTransitionEnd"),b.prototype),R(b.prototype,"expand",[d],Object.getOwnPropertyDescriptor(b.prototype,"expand"),b.prototype),R(b.prototype,"expandWithTransition",[h],Object.getOwnPropertyDescriptor(b.prototype,"expandWithTransition"),b.prototype),R(b.prototype,"collapse",[p],Object.getOwnPropertyDescriptor(b.prototype,"collapse"),b.prototype),R(b.prototype,"collapseWithTransition",[f],Object.getOwnPropertyDescriptor(b.prototype,"collapseWithTransition"),b.prototype),R(b.prototype,"toggle",[m],Object.getOwnPropertyDescriptor(b.prototype,"toggle"),b.prototype),R(b.prototype,"toggleWithTransition",[v],Object.getOwnPropertyDescriptor(b.prototype,"toggleWithTransition"),b.prototype),R(b.prototype,"registerContentElement",[g],Object.getOwnPropertyDescriptor(b.prototype,"registerContentElement"),b.prototype),b)
e.default=S,Ember._setComponentTemplate(C,S)})),define("ember-load-initializers/index",["exports","require"],(function(e,t){"use strict"
