...
null===(t=(r=this.args).onReady)||void 0===t||t.call(r,e)}_handleManualState(){!0===this.args.expanded?this._expand():!1===this.args.expanded&&this._collapse()}_collapse(){this.isExpanded=!1,this._afterCollapse()}_afterCollapse(){var e,t
this.renderContent=!1,null===(e=(t=this.args).onAfterCollapse)||void 0===e||e.call(t)}async _collapseWithTransition(){this.isExpanded=!1,this.isTransitioning=!0,await(0,i.waitForFrame)(),this._adjustToScrollHeight(),await(0,i.waitForFrame)(),this._adjustToZeroHeight(),await(0,i.waitForTransition)(this.contentElement,"max-height"),this._adjustToNoneHeight(),this._afterCollapseWithTransition()}_afterCollapseWithTransition(){var e,t
this.renderContent=!1,this.isTransitioning=!1,null===(e=(t=this.args).onAfterCollapseTransition)||void 0===e||e.call(t)}_expand(){this.renderContent=!0,this.isExpanded=!0,this._afterExpand()}_afterExpand(){var e,t
...
function n(e,t){return new Promise((r=>{e.addEventListener("transitionend",(function n(i){e===i.target&&(t&&t!==i.propertyName||(e.removeEventListener("transitionend",n),r()))}))}))}function i(e,t){return new Promise((r=>{e.addEventListener("animationend",(function n(i){e===i.target&&(t&&t!==i.animationName||(e.removeEventListener("animationend",n),r()))}))}))}function a(){return new Promise(window.requestAnimationFrame)}r.r(t),r.d(t,"waitForTransition",(function(){return n})),r.d(t,"waitForAnimation",(function(){return i})),r.d(t,"waitForFrame",(function(){return a}))}])
